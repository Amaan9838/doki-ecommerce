...
const ProductDetailsPage = ({ product }) => {
 ...
 const [wishlistLoading, setWishlistLoading] = useState(false);
  ...
  //       toast({title: 'Product already added to cart!'});
  ...
  //       toast({title: 'Product Added To Cart!'});
        ...
        //   items: [
        //     {
        //       item_id: `SKU_${cartItems.id}`,
        //       item_name: cartItems.name, 
...
//         existingCartItem = cartItems[0]; // Assuming there's only one cart item per user
//         updatedProductList = Array.isArray(existingCartItem.ProductList) 
//             ? [...existingCartItem.ProductList] 
//             : [];
//     }
...
//         const totalAmount = updatedProductList.reduce((sum, item) => {
//           const itemPrice = item.product === product.id ? totalPrice : item.product.attributes.price;
...
//           GlobalApi.updateCartItem(existingCartItem.id, data, jwt).then(
//             (resp) => {
//               setUpdateCart(!updateCart);
//               setLoading(false);
