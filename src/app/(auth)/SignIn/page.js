            ...
            <>
              <div className="grid gap-y-4">
                ...
                <button
                  ...
                  onClick={onSignIn}
                  disabled={loading}
                  className="py-3 px-4 inline-flex justify-center items-center gap-x-3 text-center bg-gray-700 hover:bg-black border border-transparent text-sm lg:text-base text-white font-semibold rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:pointer-events-none dark:focus:ring-offset-gray-800"
                >
