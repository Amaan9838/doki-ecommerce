...
// console.log("this is the user:",user.id)
    ...
    GlobalApi.getCategory(lang).then(resp=>{
    ...
    <>
      <header className="bg-white text-gray-800 shadow-2xl rounded-3xl mx-2.5 lg:mx-5 fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto flex justify-between items-center py-4">
          ...
          {/* Logo */}
          <Link href="/"><img src="https://res.cloudinary.com/duuj30a0s/image/upload/v1725542772/qj7bcffode91khhygg5k.png" alt="Logo" className="h-6" /></Link>
                ...
                >
                  ...
                  <div className="flex justify-between items-start">
                    <div className="w-1/3 px-6">
                      <img
                        src="https://res.cloudinary.com/duuj30a0s/image/upload/v1725542533/zuzmbpzxtmbzaw4dj4oq.jpg"
                        alt="Accessories"
...
{/* <li className="py-4"><a href="/categories" className="text-xl font-medium px-12 text-gray-700 hover:text-gray-900">NEW ARRIVALS</a></li>
            ...
            <a href="/categories" className="text-sm font-semibold text-gray-700 hover:text-gray-900 py-1 lg:pr-2">  {dict.about}
            </a>
              ...
              <div className="fixed top-[0] lg:top-[12.5%] lg:ml-6 lg:rounded-3xl left-0 w-full lg:w-[96%] bg-white lg:h-[80vh]  p-6 h-[95vh] z-50">
                <div className="flex flex-col justify-between p-4">
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <h2 className="text-xl font-semibold">{dict.header_search}</h2>
          ...
          <div className="">
            <div className="flex flex-col p-4">
              <div className="flex justify-between items-center py-4 border-b">
                <Link href="/">
                  <img src="https://res.cloudinary.com/duuj30a0s/image/upload/v1725542772/qj7bcffode91khhygg5k.png" alt="Logo" className="h-6" />
                </Link>
              ...
              <a href="/" className="text-gray-800 text-lg pt-2">{dict.home}</a>
              ...
              <a href="/about" className="text-gray-800 text-lg py-2">{dict.about}</a>
              <a href="/contact" className="text-gray-800 text-lg py-2">Contact</a>
            </div>
          </div>
        </motion.div>
      )}
