export default function Testimonials({dict}){
    ...
    return (
        <section className="relative py-14 md:mx-8 mt-16 md:mt-24">
                            ...
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-gray-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-gray-500" />
                                            <div>
            ...
            <div className="absolute top-0 w-full h-[350px] bg-[#beffd4] rounded-t-3xl" ></div>
        </section>
    )
}