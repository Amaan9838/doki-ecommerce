      ...
      <div className="m-10 lg:m-20 w-full lg:max-w-[500px] p-4 sm:p-14 bg-white border border-gray-200 rounded-3xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
        <div className="text-center">
          <div className="flex items-center justify-center">
           <a href="/"><Image unoptimized={true} src={'https://res.cloudinary.com/duuj30a0s/image/upload/v1725542700/ixduldkgpg66z3rs0ozb.png'} width={200} height={150} className="pb-4" /></a> 
          </div>
