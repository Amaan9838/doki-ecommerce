...
const getCategory = (locale) => axiosClient.get(`/categories?locale=${locale}&populate=*`);

const getProducts = (locale) => axiosClient.get(`/products?locale=${locale}&populate=*`);

const getProductById = (id,locale ) => axiosClient.get(`/products/${id}?locale=${locale}&populate=*`);

const getHeroSections = (locale) => axiosClient.get(`/hero-sections?locale=${locale}&populate=*`);

const getCategoryList = (locale) => axiosClient.get(`/categories?locale=${locale}&populate=*`).then(resp=>{
    return resp.data.data;
})

const getProductList = (locale) => axiosClient.get(`/products?locale=${locale}&populate=*`).then(resp=>{
    return resp.data.data;
})
